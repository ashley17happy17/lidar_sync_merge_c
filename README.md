...
## Build
The project is built with plain CMake (no ROS / catkin required). Run the shell script and it
will download the third-party library from gitlab and build the code into `src/build`.
```
bash build.sh
...
```
`build.sh` honours two optional environment variables: `BUILD_TYPE` (default `RelWithDebInfo`)
and `JOBS` (default `nproc`).
...
bash run.sh
```
The executable itself is `build/lidar_dynamic_merge_c_node <config.yaml>`.
...
# Data IO
gnss_file: "/root/ws/pcd/20260508_a/20260508102440_gnss_full_only_ublox.csv"
gnss_std_thres: 500.0  # unit: meter
gnss_freq: 10 # unit: Hz

# LIDAR parameters (GNSS Antenna to LiDAR in Front/Right/Down Axes(meter,degree))
lidar1_fp: "/root/ws/pcd/20260508_a/ouster_top/"    # If there's no LiDAR data input, leave "", but can't all LiDARs are ""
lidar1_format: "PCD_BINARY"    # Supported:  OUSTER_OS1_128, OUSTER_OS1_32, VELODYNE_VLP16, VELODYNE_VLS128
lidar1_type: "OUSTER_OS1_128"    # Supported: PCD_BINARY, PCD_ASCII
lidar1_la: [0.967,-0.037,0.444] # unit: meter
lidar1_bs: [0.235,-0.496,-79.108] # unit: degree  //[-0.235, 0.496, 100.892]

lidar2_fp: "/root/ws/pcd/20260508_a/velo_LR/"
...
lidar3_fp: "/root/ws/pcd/20260508_a/velo_RR/"
...
lidar4_fp: "/root/ws/pcd/20260508_a/velo_RF/"
...
lidar5_fp: "/root/ws/pcd/20260508_a/velo_LF/"
